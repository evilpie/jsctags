...
function initCoreObjs() {
    ...
    var _Array = (function () {
        ...
        return function(args, h, withNew) {
          ...
          retval.forEachObj(function (o) {
              ...
              h = updateHeapObjProp(o, "length-", ANUM);
            });
  ...
  (function () {
    ...
    function _Error(args, h) {
      args[0].forEachObj(function (o) {
          ...
          h = updateHeapObjProp(o, "message-", ASTR);
        });
      return new Ans(args[0], undefined, h);
    }
    ...
    heap[eavaddr] = eav;
    core["Error"] = eavaddr;
    updateHeapObjProp(e, "prototype-", epav);
    updateHeapObjProp(ep, "constructor-", eav);
    updateHeapObjProp(ep, "name-", ASTR);
  })();
  ...
  (function () {
    ...
    heap[ravaddr] = rav;
    core["RegExp"] = ravaddr;
    updateHeapObjProp(r, "prototype-", rpav);
    updateHeapObjProp(rp, "constructor-", rav);
  })();
}
...
function evalExp(n, fr, h) {
  ...
  case OBJECT_INIT:
    ...
    n.forEach(function(pinit) {
        ...
        fr = ans.fr;
        h = updateHeapObjProp(newobj, pinit[0].name, ans.v);
        errval = maybeavjoin(errval, ans.err);
      });
  ...
  case ARRAY_INIT:
    ...
    n.forEach(function(elm, i) {
        ...
        fr = ans.fr;
        h = updateHeapObjProp(newarray, i + "-", ans.v);
        errval = maybeavjoin(errval, ans.err);
      });
