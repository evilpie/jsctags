...
function initCoreObjs() {
  ...
  (function () {
    ...
    attachMethod(np, "toString",
                 function(args, h) { return new Ans(ASTR, undefined, h); });
    // Number.prototype.valueOf
    attachMethod(np, "valueOf",
                 function(args, h) { return new Ans(ANUM, undefined, h); });
