...
Aobj.prototype.updateProto = function(av) {
  this[0] = (this[0]) ? avjoin(av, this[0]) : av;
};
...
// Aobj -> Aval or undefined
function getHeapFObjProto(o) {
  return o["prototype-"];
}
...
function makeDefaultProto(n) {
  var o = new Aobj({}); //FIXME: the global object is the prototype of o.
...
// array of Aval, boolean -> Ans w/out fr
...
function evalExp(n, fr, h) {
  ...
  case DOT_PROTO:
    ...
    ans.v.forEachObj(function(o) {
        ...
        else if (proto = getHeapFObjProto(o)) {
          av = avjoin(av, proto);
        }
...
// function node, array of Aval, timestamp -> Ans w/out fr
