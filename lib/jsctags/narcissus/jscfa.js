...
(function() {
  ...
  evalLvalId[GLOBAL] = _globalref;
  evalLvalId[HEAP]   = _heapref;
  evalLvalId[STACK]  = _stackref;

  evalLval[IDENTIFIER] = function(n, ans, oldlval) {
    return evalLvalId[n.kind](n, ans, oldlval);
  };
...
(function() {
  ...
  evalExpId[GLOBAL] = _globalref;
  evalExpId[HEAP]   = _heapref;
  evalExpId[STACK]  = _stackref;

  evalExp[IDENTIFIER] = function(n, fr) { return evalExpId[n.kind](n, fr); };
  evalExp[NUMBER]        = _num;
  evalExp[STRING]        = _str;
  evalExp[TRUE]          = _bool;
  evalExp[FALSE]         = _bool;
