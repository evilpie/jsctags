...
function initCoreObjs() {
  ...
  attachMethod(op, "valueOf", toThis);
  ...
  (function () {
    ...
    attachMethod(ap, "pop", getelms);
    attachMethod(ap, "push", putelms);
    attachMethod(ap, "slice", toThis);
    attachMethod(ap, "sort", toThis);
    attachMethod(ap, "splice", toThis);
    attachMethod(ap, "shift", getelms);
    ...
    if (pt === NUMBER) {
      ...
      avobj.forEachObj(function(o) {
          if (o.numPropsMerged)
            ...
            av = avjoin(av, o.getProp(prop.value.toString() + "-"));      
        });
    }
    else if (pt === STRING)
